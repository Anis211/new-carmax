      ...
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                ...
                <div className="bg-gray-50 md:p-4 p-2 rounded-lg mb-4">
                ...
                <div className="mb-4">
                  ...
                  <div className="bg-white border rounded-lg overflow-x-scroll">
          ...
          <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <div>
              <button
                onClick={() => setIsUpdateStatus(!isUpdateStatus)}
                type="button"
              ...
              >
                {!isUpdateStatus ? "Open Update Status" : "Close Update Status"}
              </button>
              {isUpdateStatus && (
                <div className="flex flex-col justify-center items-center gap-1 rounded-lg px-4 py-4">
                  <SelectField
                    label="Update Status"
                    id="status"
                    value={status}
                    ...
                    options={["Delivered", "Shipped", "Processing", "Canceled"]}
                  />
                  <button
                    onClick={handleSubmit}
                    type="button"
                    className="w-full mr-3 inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm cursor-pointer"
                  >
                    Update Status
                  </button>
                </div>
            ...
            <button
              ...
              className="mt-3 w-full max-h-9 inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm cursor-pointer"
            >
              Close
            </button>
          </div>
